...
def InterpModel(teff, logg=4, metal=0, alpha=0, kzz=0, co=0, fsed=20, modelset='phoenix-aces-agss-cond-2011', instrument='nirspec', order='O33'):
    ...
    def GetModel(temp, wave=False, **kwargs):
        ...
        if modelset.lower() == 'btsettl08' and instrument.lower() == 'nirspec': 
            ...
            elif '2024' in modelset.lower():
                if instrument.lower() == 'nirspec':
                    filename = '%s'%smart.ModelSets[modelset.lower()] + '_t{0:03d}'.format(int(temp.data[0])) + '_g{0:.2f}'.format(float(logg)) + '_z{0:.2f}'.format(float(metal)) + '_fsed{0:.2f}_CO1.00'.format(float(fsed)) + '_%s-O%s.fits'%(instrument.upper(), order.upper())
                else:
                    filename = '%s'%smart.ModelSets[modelset.lower()] + '_t{0:03d}'.format(int(temp.data[0])) + '_g{0:.2f}'.format(float(logg)) + '_z{0:.2f}'.format(float(metal)) + '_fsed{0:.2f}_CO1.00'.format(float(fsed)) + '_%s-%s.fits'%(instrument.upper(), order.upper())
            else:
                if instrument.lower() == 'nirspec':
    ...
    if modelset.lower() == 'sonora-2023':
        ...
        if (teff, logg, metal, fsed) in zip(T1['teff'], T1['logg'], T1['M_H'], T1['fsed']):
            index0 = np.where( (T1['teff'] == teff) & (T1['logg'] == logg) & (T1['M_H'] == metal) & (T1['fsed'] == fsed) )
            #flux2  = GetModel(T1['teff'][index0], T1['logg'][index0], T1['M_H'][index0], modelset=modelset )
            #waves2 = GetModel(T1['teff'][index0], T1['logg'][index0], T1['M_H'][index0], modelset=modelset, wave=True)
            flux2  = GetModel(T1['teff'][index0], logg=T1['logg'][index0], metal=T1['M_H'][index0], fsed=T1['fsed'][index0], instrument=instrument, order=order, gridfile=T1)
            waves2 = GetModel(T1['teff'][index0], logg=T1['logg'][index0], metal=T1['M_H'][index0], fsed=T1['fsed'][index0], instrument=instrument, order=order, gridfile=T1, wave=True)
            return waves2, flux2
    ...
    try:
        ...
        if modelset.lower() == 'sonora-2024':
            ...
            # Get the nearest grid point to fsed
            t0 = np.max(list(set(T1['fsed'][np.where( (T1['teff'] == x0) & (T1['logg'] == y0) & (T1['M_H'] == z0) & (T1['fsed'] <= fsed) )]) & 
    ...
    if  modelset.lower() == 'sonora-2023':
        ...
        # Get the 16 points
        ind0000 = np.where( (T1['teff'] == x0) & (T1['logg'] == y0) & (T1['M_H'] == z0) & (T1['fsed'] == t0) ) # 0000
        ind0001 = np.where( (T1['teff'] == x0) & (T1['logg'] == y0) & (T1['M_H'] == z0) & (T1['fsed'] == t1) ) # 0001
        ind0010 = np.where( (T1['teff'] == x0) & (T1['logg'] == y0) & (T1['M_H'] == z1) & (T1['fsed'] == t0) ) # 0010
        ind0011 = np.where( (T1['teff'] == x0) & (T1['logg'] == y0) & (T1['M_H'] == z1) & (T1['fsed'] == t1) ) # 0011
        ind0100 = np.where( (T1['teff'] == x0) & (T1['logg'] == y1) & (T1['M_H'] == z0) & (T1['fsed'] == t0) ) # 0100
        ind0101 = np.where( (T1['teff'] == x0) & (T1['logg'] == y1) & (T1['M_H'] == z0) & (T1['fsed'] == t1) ) # 0101
        ind0110 = np.where( (T1['teff'] == x0) & (T1['logg'] == y1) & (T1['M_H'] == z1) & (T1['fsed'] == t0) ) # 0110
        ind0111 = np.where( (T1['teff'] == x0) & (T1['logg'] == y1) & (T1['M_H'] == z1) & (T1['fsed'] == t1) ) # 0111
        ind1000 = np.where( (T1['teff'] == x1) & (T1['logg'] == y0) & (T1['M_H'] == z0) & (T1['fsed'] == t0) ) # 1000
        ind1001 = np.where( (T1['teff'] == x1) & (T1['logg'] == y0) & (T1['M_H'] == z0) & (T1['fsed'] == t1) ) # 1001
        ind1010 = np.where( (T1['teff'] == x1) & (T1['logg'] == y0) & (T1['M_H'] == z1) & (T1['fsed'] == t0) ) # 1010
        ind1011 = np.where( (T1['teff'] == x1) & (T1['logg'] == y0) & (T1['M_H'] == z1) & (T1['fsed'] == t1) ) # 1011
        ind1100 = np.where( (T1['teff'] == x1) & (T1['logg'] == y1) & (T1['M_H'] == z0) & (T1['fsed'] == t0) ) # 1100
        ind1101 = np.where( (T1['teff'] == x1) & (T1['logg'] == y1) & (T1['M_H'] == z0) & (T1['fsed'] == t1) ) # 1101
        ind1110 = np.where( (T1['teff'] == x1) & (T1['logg'] == y1) & (T1['M_H'] == z1) & (T1['fsed'] == t0) ) # 1110
        ind1111 = np.where( (T1['teff'] == x1) & (T1['logg'] == y1) & (T1['M_H'] == z1) & (T1['fsed'] == t1) ) # 1111
        Points =  [ [np.log10(T1['teff'][ind0000].data[0]), T1['logg'][ind0000].data[0], T1['M_H'][ind0000].data[0], T1['fsed'][ind0000].data[0],                          
                     np.log10(GetModel(T1['teff'][ind0000], logg=T1['logg'][ind0000], metal=T1['M_H'][ind0000], fsed=T1['fsed'][ind0000], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind0001].data[0]), T1['logg'][ind0001].data[0], T1['M_H'][ind0001].data[0], T1['fsed'][ind0001].data[0],                          
                     np.log10(GetModel(T1['teff'][ind0001], logg=T1['logg'][ind0001], metal=T1['M_H'][ind0001], fsed=T1['fsed'][ind0001], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind0010].data[0]), T1['logg'][ind0010].data[0], T1['M_H'][ind0010].data[0], T1['fsed'][ind0010].data[0],                          
                     np.log10(GetModel(T1['teff'][ind0010], logg=T1['logg'][ind0010], metal=T1['M_H'][ind0010], fsed=T1['fsed'][ind0010], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind0011].data[0]), T1['logg'][ind0011].data[0], T1['M_H'][ind0011].data[0], T1['fsed'][ind0011].data[0],                          
                     np.log10(GetModel(T1['teff'][ind0011], logg=T1['logg'][ind0011], metal=T1['M_H'][ind0011], fsed=T1['fsed'][ind0011], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind0100].data[0]), T1['logg'][ind0100].data[0], T1['M_H'][ind0100].data[0], T1['fsed'][ind0100].data[0],                          
                     np.log10(GetModel(T1['teff'][ind0100], logg=T1['logg'][ind0100], metal=T1['M_H'][ind0100], fsed=T1['fsed'][ind0100], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind0101].data[0]), T1['logg'][ind0101].data[0], T1['M_H'][ind0101].data[0], T1['fsed'][ind0101].data[0],                          
                     np.log10(GetModel(T1['teff'][ind0101], logg=T1['logg'][ind0101], metal=T1['M_H'][ind0101], fsed=T1['fsed'][ind0101], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind0110].data[0]), T1['logg'][ind0110].data[0], T1['M_H'][ind0110].data[0], T1['fsed'][ind0110].data[0],                          
                     np.log10(GetModel(T1['teff'][ind0110], logg=T1['logg'][ind0110], metal=T1['M_H'][ind0110], fsed=T1['fsed'][ind0110], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind0111].data[0]), T1['logg'][ind0111].data[0], T1['M_H'][ind0111].data[0], T1['fsed'][ind0111].data[0],                          
                     np.log10(GetModel(T1['teff'][ind0111], logg=T1['logg'][ind0111], metal=T1['M_H'][ind0111], fsed=T1['fsed'][ind0111], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind1000].data[0]), T1['logg'][ind1000].data[0], T1['M_H'][ind1000].data[0], T1['fsed'][ind1000].data[0],                          
                     np.log10(GetModel(T1['teff'][ind1000], logg=T1['logg'][ind1000], metal=T1['M_H'][ind1000], fsed=T1['fsed'][ind1000], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind1001].data[0]), T1['logg'][ind1001].data[0], T1['M_H'][ind1001].data[0], T1['fsed'][ind1001].data[0],                          
                     np.log10(GetModel(T1['teff'][ind1001], logg=T1['logg'][ind1001], metal=T1['M_H'][ind1001], fsed=T1['fsed'][ind1001], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind1010].data[0]), T1['logg'][ind1010].data[0], T1['M_H'][ind1010].data[0], T1['fsed'][ind1010].data[0],                          
                     np.log10(GetModel(T1['teff'][ind1010], logg=T1['logg'][ind1010], metal=T1['M_H'][ind1010], fsed=T1['fsed'][ind1010], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind1011].data[0]), T1['logg'][ind1011].data[0], T1['M_H'][ind1011].data[0], T1['fsed'][ind1011].data[0],                          
                     np.log10(GetModel(T1['teff'][ind1011], logg=T1['logg'][ind1011], metal=T1['M_H'][ind1011], fsed=T1['fsed'][ind1011], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind1100].data[0]), T1['logg'][ind1100].data[0], T1['M_H'][ind1100].data[0], T1['fsed'][ind1100].data[0],                          
                     np.log10(GetModel(T1['teff'][ind1100], logg=T1['logg'][ind1100], metal=T1['M_H'][ind1100], fsed=T1['fsed'][ind1100], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind1101].data[0]), T1['logg'][ind1101].data[0], T1['M_H'][ind1101].data[0], T1['fsed'][ind1101].data[0],                          
                     np.log10(GetModel(T1['teff'][ind1101], logg=T1['logg'][ind1101], metal=T1['M_H'][ind1101], fsed=T1['fsed'][ind1101], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind1110].data[0]), T1['logg'][ind1110].data[0], T1['M_H'][ind1110].data[0], T1['fsed'][ind1110].data[0],                          
                     np.log10(GetModel(T1['teff'][ind1110], logg=T1['logg'][ind1110], metal=T1['M_H'][ind1110], fsed=T1['fsed'][ind1110], instrument=instrument, order=order, gridfile=T1))],
                    [np.log10(T1['teff'][ind1111].data[0]), T1['logg'][ind1111].data[0], T1['M_H'][ind1111].data[0], T1['fsed'][ind1111].data[0],                          
                     np.log10(GetModel(T1['teff'][ind1111], logg=T1['logg'][ind1111], metal=T1['M_H'][ind1111], fsed=T1['fsed'][ind1111], instrument=instrument, order=order, gridfile=T1))],
                  ]
        #print(Points)
        waves2 = GetModel(T1['teff'][ind1111], logg=T1['logg'][ind1111], metal=T1['M_H'][ind1111], fsed=T1['fsed'][ind1111], instrument=instrument, order=order, gridfile=T1, wave=True)
